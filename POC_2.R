...
df = filter(dfCountries, Total.Population.2017 >10000000)  
vector_country = c(df$Country.Name) 
vector_country
...
write.csv(summary_region_full,
          "Region Summary Output.csv",
          row.names = FALSE)
